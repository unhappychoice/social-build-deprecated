	...
	public static void loadMessages() {
		...
		try {
			...
			PLAYER_CANCEL = ChatColor.DARK_AQUA
					+ bundle.getString("player_cancel");
			PLAYER_CANCELED = ChatColor.DARK_AQUA
					+ bundle.getString("player_canceled");
			PLAYER_PROMOTED = ChatColor.YELLOW
					+ bundle.getString("player_promoted");
